...
import { StyleSheet, FlatList, View, TouchableOpacity, Text, Image, Modal } from 'react-native';
...
export default function CreateChatModal({ visible, onClose }: CreateChatModalProps) {
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    marginTop: 50, // Add some spacing at the top for the status bar
  },
  backButton: {
    marginRight: 16,
    width: 40,
